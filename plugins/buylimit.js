...
let handler = async (m, { conn, command, args }) => {
  ...
  } else conn.reply(m.chat, `XP insuficiente para comprar ${count} limite`, m)
}
handler.help = ['buy<cantidad de limites>', 'buy <cantidad de limites>', 'buyall']
handler.tags = ['xp']
